...
I am an **Associate Senior Lecturer (Tenure Track) and ELLIIT faculty in Software Engineering at Blekinge Institute of Technology (BTH), Sweden, the strategic research area in IT and mobile communications. My research focuses on **AI for Software Engineering**, with broader interests in **cybersecurity and software engineering**. I have published over 25 papers in top-tier conferences and journals, including TIFS, ICSE, ISSTA, ASE, TOSEM, and EMSE. My research spans **program analysis and AI-driven software security**, **smart-contract auditing and DeFi governance**, **large-scale fuzzing and vulnerability detection**, and **mutation testing for trustworthy AI**.
